...
var StatisticalPropertiesNew = require('./statistical-properties-new');
...
class HaralickFeaturesCalculatorNew {
    ...
    variance() {
        ...
        /*this.coocMatrix.forEach(function (value, index) {
            variance = variance + Math.pow(Math.floor(index / ngLevel) - mi,2) * value;
        });*/
    ...
    correlation() {
        let correlation = 0,
            ...
            //sigmaY = this.statisticalProperties.sigmaY(miX),
            sigmaY = sigmaX,
            //sigmaX = 1,
            //sigmaY = 1,
            ngLevel = this.ngLevel,
